...
<form method="POST">
    <div class="form-group">
        ...
        <input type="text" required class="form-control" name="item_name" placeholder="Introdu denumirea itemului">
    </div>
    <div class="box-body">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>Introdu cantitatea <span id="quantity_units"></span></label>
                    <input type="number" name="quantity" required class="form-control" placeholder="Introduceți cantitatea" min="0">
                </div>
                <!-- /.form-group -->
            </div>
         </div>
